...
const SpyLogic = (props) => {
  ...
  /*
  const S3_BUCKET = 'eduhubs3userbuckets'
  const REGION = 'us-east-1'
  const ACCESS_KEY = 'AKIARQSE4VJZQS2PNZO5'
  const SECRET_ACCESS_KEY = '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'
  */
  const S3_BUCKET = 'lamda-grad-proj-bucket'
  const REGION = 'us-east-2'
  const ACCESS_KEY = 'AKIA3YUHBVMAAE7RTTTZ'
  const SECRET_ACCESS_KEY = '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'
